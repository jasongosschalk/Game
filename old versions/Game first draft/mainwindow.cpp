    ...
    ui(new Ui::MainWindow)
{
    ...
    //QPalette pal = welcomePage->palette();                   //creates a pallate object tied to the mainwindow
    //pal.setColor(this->backgroundRole(), "#CCCCFF");  //sets color of the mainWindow to be purplish
    //this->setPalette(pal);                            //commits the background color to the widget
    ...
    bottom = new QHBoxLayout(bottomWidget);      //where the start button goes--all the bottom layouts
   ...
   // titleExplanationVerticalWidget->setFixedWidth(600);
    ...
    //this portion of code sets up the middle of the screen
